...
const projectMeta = {
  ...
  category: "Security Services Website",
  year: "2026",
  role: "Web Design & Frontend Development",
  timeline: "3 Weeks",
  tools: ["React", "Tailwind CSS", "Framer Motion", "Figma"],
  liveUrl: "https://westerneaglesecurity.ca/",
};

const galleryImages = [
  "https://www.westerneaglesecurity.ca/herosection.png",
  "https://www.westerneaglesecurity.ca/About.png",
  "https://www.westerneaglesecurity.ca/security%20img.png",
];

const featuresData = [
  {
    title: "Clear Service Presentation",
    desc: "The website presents Western Eagle Security's core services clearly, helping visitors quickly understand the available security solutions.",
  },
  {
    title: "Trust-Focused Design",
    desc: "Licensed professionals, 24/7 dispatch, customized solutions, and transparent reporting are highlighted to build confidence with potential clients.",
  },
  {
    title: "Conversion-Focused Experience",
    desc: "Clear calls to action such as requesting a free quote, calling the company, and applying for security jobs make the next step easy for visitors.",
  },
];
    ...
    <div className="w-full bg-[#FAF6EF] text-[#1E1712] selection:bg-[#B08D57]/20 font-sans antialiased">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-10">
            ...
            {projectMeta.liveUrl !== "#" && (
              <motion.a
                ...
                className="inline-flex items-center gap-2 px-7 py-3 rounded-full bg-[#171210] text-[#D9C08C] font-bold text-xs uppercase tracking-widest hover:bg-[#B08D57] hover:text-[#171210] transition-colors duration-300 w-fit"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
      ...
      <div className="w-full px-6 pb-20">
        ...
        >
          <img
            src="/assets/WES1.png"
            alt="Western Eagle Security website"
        ...
        <div className="max-w-[1300px] mx-auto grid grid-cols-1 lg:grid-cols-[1.4fr_1fr] gap-16">
          ...
          >
            ...
            <h2 className="text-2xl md:text-4xl font-extrabold text-[#1E1712] mb-6 leading-snug">
              A professional security services website built to establish trust
              and generate qualified inquiries.
            </h2>
            <p className="text-[#3A2E1F] text-base md:text-lg font-light leading-relaxed mb-6">
              Western Eagle Security needed a professional online presence that
              clearly communicates its security services across Calgary and
              Alberta. The website was structured to make essential information
              easy to find while presenting the company as a dependable and
            ...
            <p className="text-[#3A2E1F] text-base md:text-lg font-light leading-relaxed">
              ...
              hierarchy, service-focused sections, strong calls to action, and
              subtle motion that keeps the experience engaging without
              distracting from the business information.
            </p>
          </motion.div>
