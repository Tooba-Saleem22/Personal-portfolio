...
const featuresData = [
  {
    ...
    desc: "Structured around the studio's portfolio work rather than generic sections — every scroll reveals a reason to keep going.",
  },
  {
    title: "Motion With Purpose",
    desc: "Subtle scroll-triggered animation guides attention without slowing the page down or feeling gimmicky.",
  },
  {
    title: "Built to Scale",
    desc: "Component-driven React architecture, so new case studies can be added without touching the core layout.",
  },
];
        ...
        <div className="max-w-[1300px] mx-auto grid grid-cols-1 lg:grid-cols-[1.4fr_1fr] gap-16">
          ...
          >
            ...
            <h2 className="text-2xl md:text-4xl font-extrabold text-[#1E1712] mb-6 leading-snug">
              A fast, content-first React build for a design studio.
            </h2>
            <p className="text-[#3A2E1F] text-base md:text-lg font-light leading-relaxed mb-6">
              Thedesignspark needed a portfolio site that felt as considered as
              the studio's own client work — something that got out of the way
              of the projects themselves rather than competing with them. The
              brief was clarity: generous whitespace, effortless navigation, and
              a layout that let the studio's case studies do the talking.
            </p>
            <p className="text-[#3A2E1F] text-base md:text-lg font-light leading-relaxed">
              The result is a React site structured around a clean visual
              hierarchy, with subtle motion that draws the eye without ever
